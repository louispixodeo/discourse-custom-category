...
createWidget('custom-nav', {
  ...
  <ul id="menu-main" class="menu-wrapper">
    ...
    <li id="menu-item-2057" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children menu-item-2057">
      ...
      <ul class="sub-menu">
        <li id="menu-item-3060" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-3060"><a href="https://www.partirseul.com/continents/">Pays</a></li>
        ...
        <li id="menu-item-2902" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-2902"><a href="https://www.partirseul.com/location-de-voiture/">Location de voiture</a></li>
    ...
    <li id="menu-item-3971" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children menu-item-3971">
      ...
      <ul class="sub-menu">
        ...
        <li id="menu-item-4088" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-4088"><a href="https://www.partirseul.com/nos-voyages-exclusifs/">Nos voyages exclusifs</a></li>
      </ul>
    </li>
